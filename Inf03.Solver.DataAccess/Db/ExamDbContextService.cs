...
public class ExamDbContextService
{
    ...
    public string JsonConnectionStringDeserialize()
    {
        ...
        var connectionString = JsonSerializer.Deserialize<ConnectionStringRootModel>(reader);
        return connectionString?.ConnectionStringModel.Db1 ?? string.Empty;
    }

    public static ExamDbContextService CreateExamDbContextService()
    {
        return new ExamDbContextService();
    }
}
